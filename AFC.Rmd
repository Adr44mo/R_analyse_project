...
# 🟢 2. Créer le tableau de contingence entre `sector` et `esgPerformance`
...
# 🟢 4. Visualiser les résultats avec un biplot
fviz_ca_biplot(afc_result, repel = TRUE)

```
Explications des résultats de l'AFC:
```{r}
# 🟢 6. Visualiser les contributions des modalités
...
# 🟢 7. Visualiser les contributions des variables
...
# 7. Créer une matrice contenant tous les profils
M <- rbind(Techology, Energy, Financial, moyen = moyen)

# 🟢 8. Afficher la matrice des profils
print(M)

# 🟢 9. Visualisation en barplot
